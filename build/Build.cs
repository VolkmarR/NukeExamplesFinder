...
[GitHubActions("Run", GitHubActionsImage.WindowsLatest, OnCronSchedule = "* 12 * * *")]
...
class Build : NukeBuild
{
    ...
    Target Run => _ => _
        ...
        .Executes(() =>
        {
            var settings = new { Credentials = new { GitHubToken = "" }, DataFiles = new { Path = ArtifactsDirectory / "XXX" } };
